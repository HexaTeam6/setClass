...
<div class="container">
  ...
  <center><h1 style="background-color: #D4D4D4"><b>LAPORAN STOCK OPNAME</b></h1></center>
            ...
            <tbody>
				...
				?>
                    <tr>
                        ...
                        <td class="no_stock_opname"><?php echo $row->no_stock_opname;?></td>
                        <td class="tanggal"><?php echo $row->tanggal;?></td>
                        <td class="nama_bahan_baku"><?php echo $row->nama_bahan_baku;?></td>
                        <td class="jml_stock" style="text-align:right"><?php echo $row->jml_stock;?></td>
                        <td class="jml_terpakai" style="text-align:right"><?php echo $row->jml_terpakai;?></td>
                        <td class="jml_sisa" style="text-align:right"><?php echo $row->jml_sisa;?></td>
