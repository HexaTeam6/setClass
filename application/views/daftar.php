...
<!-- Mirrored from wrappixel.com/demos/admin-templates/material-pro/material/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2017 20:24:54 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li>
                                <a href="https://wrappixel.com/demos/admin-templates/material-pro/minisidebar/index.html">Minisidebar</a>
                            </li>
                            <li>
                                <a href="https://wrappixel.com/demos/admin-templates/material-pro/horizontal/index2.html">Horizontal</a>
                            </li>
                            <li><a href="https://wrappixel.com/demos/admin-templates/material-pro/dark/index3.html">Dark
                                    Version</a></li>
                            <li>
                                <a href="https://wrappixel.com/demos/admin-templates/material-pro/material-rtl/index4.html">RTL
                                    Version</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <h6 class="card-subtitle">You can find the <a href="http://www.jquery-steps.com/"
                                                                          target="_blank">offical website</a></h6>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control" id="intType1"
                                                        data-placeholder="Type to search cities" name="intType1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control" id="participants1"
                                                        name="location">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="c-inputs-stacked">
                                                    <label class="inline custom-control custom-checkbox block">
                                                        <input type="checkbox" class="custom-control-input"> <span
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description ml-0">1 star</span>
                                                    </label>
                                                    <label class="inline custom-control custom-checkbox block">
                                                        <input type="checkbox" class="custom-control-input"> <span
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description ml-0">2 star</span>
                                                    </label>
                                                    <label class="inline custom-control custom-checkbox block">
                                                        <input type="checkbox" class="custom-control-input"> <span
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description ml-0">3 star</span>
                                                    </label>
                                                    <label class="inline custom-control custom-checkbox block">
                                                        <input type="checkbox" class="custom-control-input"> <span
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description ml-0">4 star</span>
                                                    </label>
                                                    <label class="inline custom-control custom-checkbox block">
                                                        <input type="checkbox" class="custom-control-input"> <span
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description ml-0">5 star</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
...
<!-- Mirrored from wrappixel.com/demos/admin-templates/material-pro/material/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2017 20:24:56 GMT -->
</html>
