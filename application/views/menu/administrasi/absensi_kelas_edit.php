        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo site_url('AbsensiKelas/update')?>" method="post">
                                ...
                                <table id="datatable" class="table table-bordered table-striped">
                                    ...
                                    foreach ($detail as $row):?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                    <select class="selectpicker form-control required" id="wstatus-<?php echo $row->NIS?>"
...
<script>
    $(function () {
        ...
        $("#wstatus-<?php echo $row->NIS?>").selectpicker('val', '<?php echo $row->status?>');
        <?php endforeach;?>
