        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Kas Masuk</h3>
                    <ol class="breadcrumb">
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" id="form">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" id="kode_kas_masuk" name="kode_kas_masuk">
                ...
                <div class="card-body">
                    <div class="table-responsive m-t">
                        ...
                        <div style="position:relative; float: right">
                            <a href="<?php echo site_url('/KasMasuk/excel')?>" id="btnExcel" class="btn btn-info waves-effect waves-light"
                               style="background: #1F6F43; border: 0px"
                               data-toggle="tooltip" data-title="Export Excel">
                                <i class="mdi mdi-file-excel"></i>
                            </a>
                            <a href="<?php echo site_url('/KasMasuk/pdf')?>" id="btnPdf" class="btn btn-info waves-effect waves-light"
                            ...
                            <table id="datatable" class="table table-bordered table-striped">
                                ...
                                foreach ($data as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td class="kode_kas_masuk">
                                            <label class="label label-inverse"><?php echo $row->kode_kas_masuk;?></label>
                                        </td>
                                        <td class="nama">
...
<script>
    $(function () {
        ...
        $('#btnAdd').click(function () {
            $('#form').attr('action', "<?php echo site_url('/KasMasuk/insert')?>");
        ...
        $('#datatable').on('click', '[id^=btnDelete]', function() {
            var $item = $(this).closest("tr");
            var kode = $.trim($item.find(".kode_kas_masuk").text());
...
//                        alert(kode);
                        $.ajax({
                            url: "<?php echo site_url("/KasMasuk/delete/");?>" + kode,
