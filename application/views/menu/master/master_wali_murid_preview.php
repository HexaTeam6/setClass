        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Preview Wali Murid</h3>
                    <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30">
                                    ...
                                    <h6 class="card-subtitle"><?php echo $user->hak_akses?></h6>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="profile" role="tabpanel">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <label class="col-md-3 font-weight-bold float-left">Keterangan</label>
                                            <label class="col-md-6">
                                                Wali murid dari <a href="<?php echo site_url('MasterSiswa/preview/').$user->NIS?>" class="text-warning font-weight-bold" data-toggle="tooltip" title="Profil"><?php echo $user->nama_siswa?></a>
                                                <label class="label label-inverse"><?php echo $user->hubungan_dengan_siswa?></label>
                                            </label>
                                        </div>
