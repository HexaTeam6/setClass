...
<!--Wizard JS-->
<script src="<?php echo base_url('/assets/materialPro/plugins/wizard/jquery.steps.min.js') ?>"></script>
<script src="<?php echo base_url('/assets/materialPro/plugins/wizard/jquery.validate.min.js') ?>"></script>
<!--SweetAlert JS-->
