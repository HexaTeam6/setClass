...
$html = '
  ...
  <h1 style="background-color: #D4D4D4; text-align: center;"><b>KAS MASUK</b></h1>
          <table>
            <thead>
            <tr>
			  <th width="12%"><b>Tanggal</b></th>
              <th width="27%"><b>Kode Kas Masuk</b></th>
            ...
            <tbody> ';
				...
				foreach($data as $row){
                    ...
                    <tr>
						...
						<td width="27%" class="kode_kas_keluar">'.$row->kode_kas_masuk.'</td>
...
$pdf->Output('Report-Kas Masuk.pdf', 'I');
